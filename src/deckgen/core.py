...
a.cp{border-style:solid;text-decoration:none;cursor:pointer;left:auto;right:120px;width:auto;padding:0 28px;white-space:nowrap}a.cp:hover{background:#ED6D24;color:#fff}a.cp:hover b{background:#fff}
